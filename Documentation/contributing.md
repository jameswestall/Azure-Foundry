...
## Report bugs using Github's [issues](https://github.com/jameswestall/azure-foundry/issues)
...
* You can try running `terraform fmt -r` for style unification
